...
- A7: Home digest counts: "new" and "interrupts" are today-only (messageTs ≥ local midnight); "drafts awaiting review" is the standing count of ALL awaiting-review items — a 3-day-old unreviewed draft still matters. Spec §5 said "counts from today's comm_items"; the drafts figure deliberately deviates.
