...
function AreaDialog({ area, workspaceId, onClose, onSave, onDelete, linkedProjectCount = 0, linkedTaskCount = 0 }: AreaDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
      ...
      <div className="relative w-full sm:max-w-md bg-[#281E16] border border-[rgba(167,155,120,0.22)] sm:rounded-none rounded-t-[16px] overflow-hidden">
        ...
        <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto overflow-x-hidden">
          ...
          <textarea
            ...
            rows={2}
            className="w-full px-3 py-2.5 rounded-none bg-[#140F0B] border border-[rgba(167,155,120,0.13)] text-[#E8DFCE] placeholder-[#5C5340] text-sm outline-none focus:border-[rgba(167,155,120,0.35)] resize-none"
          />
                ...
                <button
                  ...
                  className={cn(
                    ...
                    context === ctx
                      ...
                      : 'bg-[#140F0B] border-[rgba(167,155,120,0.13)] text-[#7A6F55] hover:text-[#A79B78]'
                  )}
                >{ctx}</button>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-none bg-[#140F0B] border border-[rgba(167,155,120,0.13)] text-[#E8DFCE] placeholder-[#5C5340] text-xs outline-none focus:border-[rgba(167,155,120,0.35)]"
              />
              <button
                type="button"
                onClick={() => addSphere(sphereInput)}
                className="px-3 py-2 text-xs rounded-none bg-[#140F0B] border border-[rgba(167,155,120,0.13)] text-[#A79B78] hover:text-[#E8DFCE] hover:border-[rgba(167,155,120,0.35)] transition-colors"
              >
                Add
              </button>
            </div>
          ...
          <div>
            ...
            <select value={status} onChange={e => setStatus(e.target.value)}
              className="w-full px-3 py-2.5 rounded-none bg-[#140F0B] border border-[rgba(167,155,120,0.13)] text-[#E8DFCE] text-sm outline-none focus:border-[rgba(167,155,120,0.35)] appearance-none">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <span className="text-xl w-9 h-9 flex items-center justify-center rounded-none bg-[#140F0B] border border-[rgba(167,155,120,0.13)] shrink-0">
                {icon || '📁'}
              </span>
              <input
                value={icon}
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {AREA_COLORS.map(c => (
                <button key={c} type="button" onClick={() => setColor(c)}
                  className={cn('w-6 h-6 rounded-full transition-all', color === c ? 'ring-2 ring-white ring-offset-2 ring-offset-[#281E16] scale-110' : '')}
