...
export default async function MetricsPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto">
      ...
      <div className="p-5 rounded-none bg-[#1A1510] border border-[rgba(167,155,120,0.13)] space-y-3">
        <p className="text-sm text-[#A79B78]">View the full board-level dashboards:</p>
        <div className="flex flex-col sm:flex-row gap-3">
          <Link href="/metrics/productivity" className="inline-flex items-center gap-2 px-4 py-2 rounded-none bg-[#201A14] border border-[rgba(167,155,120,0.22)] text-[#E8DFCE] text-sm font-medium hover:bg-[#272018] transition-colors">
            AI Productivity Comparison
          </Link>
          <Link href="/metrics/korus" className="inline-flex items-center gap-2 px-4 py-2 rounded-none bg-[#201A14] border border-[rgba(167,155,120,0.13)] text-[#A79B78] text-sm font-medium hover:bg-[#272018] transition-colors">
