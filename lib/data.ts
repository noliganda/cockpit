...
export const MOCK_TASKS: Task[] = [
  ...
  // Charlie Dashboard — bugs
  {
    id: 'task-cd-bug-1',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Project duplicate entries on create',
    description: 'Creating a project shows it twice in the project list.',
    status: 'backlog',
    priority: 'high',
    tags: ['bug'],
  ...
  },
  {
    ...
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Sprint duplicate entries on create',
    description: 'Creating a sprint shows 3x entries in the sprint list.',
    status: 'backlog',
    priority: 'high',
    tags: ['bug'],
    createdAt: '2026-02-24T09:01:00Z',
    updatedAt: '2026-02-24T09:01:00Z',
  },
  {
    id: 'task-cd-bug-3',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Task creation inside project doesn\'t persist',
    description: 'Task disappears after save when created from a project detail page.',
    status: 'backlog',
    priority: 'high',
    tags: ['bug'],
    createdAt: '2026-02-24T09:02:00Z',
    updatedAt: '2026-02-24T09:02:00Z',
  },
  {
    id: 'task-cd-bug-4',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Metrics page 404',
    description: '/metrics route is broken and returns a 404.',
    status: 'backlog',
    priority: 'high',
    tags: ['bug'],
    createdAt: '2026-02-24T09:03:00Z',
    updatedAt: '2026-02-24T09:03:00Z',
  },
  {
    id: 'task-cd-bug-5',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Google OAuth redirect blank page',
    description: 'Callback route was missing, resulting in a blank page after OAuth. Fixed.',
    status: 'delivered',
    priority: 'high',
    tags: ['bug'],
    createdAt: '2026-02-24T09:04:00Z',
  ...
  },
  {
    ...
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'CRM contact detail not found',
    description: 'Clicking a contact showed a not-found error. Fixed.',
    status: 'delivered',
    priority: 'high',
    tags: ['bug'],
    createdAt: '2026-02-24T09:05:00Z',
    updatedAt: '2026-02-25T10:00:00Z',
  },
  {
    id: 'task-cd-bug-7',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Task dialog missing Project field',
    description: 'No way to assign a project when creating or editing a task. Fixed.',
    status: 'delivered',
    priority: 'high',
    tags: ['bug'],
    createdAt: '2026-02-24T09:06:00Z',
    updatedAt: '2026-02-25T10:00:00Z',
  },
  {
    id: 'task-cd-bug-8',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Project detail page not found',
    description: 'Clicking a project showed a not-found error. Fixed.',
    status: 'delivered',
    priority: 'high',
    tags: ['bug'],
    createdAt: '2026-02-24T09:07:00Z',
    updatedAt: '2026-02-25T10:00:00Z',
  },
  // Charlie Dashboard — features
  {
    id: 'task-cd-feat-1',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Quick status dropdown on Kanban/List',
    description: 'Change task status without opening the full edit dialog.',
    status: 'backlog',
    priority: 'medium',
    tags: ['feature'],
  ...
  },
  {
    ...
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Sprint Board view',
    description: 'Dedicated kanban board view per sprint.',
    status: 'backlog',
    priority: 'medium',
    tags: ['feature'],
    createdAt: '2026-02-24T09:11:00Z',
    updatedAt: '2026-02-24T09:11:00Z',
  },
  {
    id: 'task-cd-feat-3',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Sprint planning drag-and-drop',
    description: 'Left panel shows backlog, right panel shows sprint; drag tasks to assign.',
    status: 'backlog',
    priority: 'medium',
    tags: ['feature'],
    createdAt: '2026-02-24T09:12:00Z',
    updatedAt: '2026-02-24T09:12:00Z',
  },
  {
    id: 'task-cd-feat-4',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'CRM address → Google Maps link',
    description: 'Make contact addresses clickable and open Google Maps.',
    status: 'backlog',
    priority: 'medium',
    tags: ['feature'],
    createdAt: '2026-02-24T09:13:00Z',
    updatedAt: '2026-02-24T09:13:00Z',
  },
  {
    id: 'task-cd-feat-5',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'CRM URL → hyperlink',
    description: 'Make contact website fields clickable hyperlinks.',
    status: 'backlog',
    priority: 'medium',
    tags: ['feature'],
    createdAt: '2026-02-24T09:14:00Z',
    updatedAt: '2026-02-24T09:14:00Z',
  },
  {
    id: 'task-cd-feat-6',
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'CRM phone → tel: link',
    description: 'Make contact phone numbers click-to-call links.',
    status: 'backlog',
    priority: 'medium',
    tags: ['feature'],
  ...
  },
  {
    ...
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'Email integration (Gmail read-only)',
    description: 'View emails in Messages tab per workspace via Gmail read-only API.',
    status: 'backlog',
    priority: 'medium',
    tags: ['feature'],
    createdAt: '2026-02-24T09:16:00Z',
  ...
  },
  {
    ...
    workspaceId: 'byron-film',
    projectId: 'proj-cd',
    title: 'WhatsApp integration (wacli read-only)',
    description: 'View WhatsApp messages in Messages tab via wacli read-only integration.',
    status: 'backlog',
    priority: 'medium',
    tags: ['feature'],
    createdAt: '2026-02-24T09:17:00Z',
    updatedAt: '2026-02-24T09:17:00Z',
  },
];
...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    description: 'Internal ops dashboard for Byron Film and KORUS Group',
    status: 'active',
